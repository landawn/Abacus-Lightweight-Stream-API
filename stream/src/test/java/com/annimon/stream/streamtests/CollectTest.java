...
public final class CollectTest {
    ...
    public void testCollectWithCollector() {
        String text = IntStream.range(0, 10).boxed().map(Functions.<Integer> convertToString()).collect(Functions.joiningCollector());
    ...
    public void testCollect123() {
        String string123 = Stream.of("1", "2", "3").collect(new Supplier<StringBuilder>() {
            @Override
