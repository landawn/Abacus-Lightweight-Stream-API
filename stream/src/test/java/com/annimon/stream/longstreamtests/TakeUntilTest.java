...
public final class TakeUntilTest {
    ...
    public void testTakeUntilFirstMatch() {
        LongStream.of(2, 4, 6, 7, 8, 10, 11).takeUntil(Functions.remainderLong(2)).chain(assertElements(arrayContaining(2L)));
    }

    @Test
    public void testTakeUntilNoneMatch() {
        LongStream.of(2, 4, 6, 7, 8, 10, 11).takeUntil(Functions.remainderLong(128)).chain(assertElements(arrayContaining(2L, 4L, 6L, 7L, 8L, 10L, 11L)));
    }
}
