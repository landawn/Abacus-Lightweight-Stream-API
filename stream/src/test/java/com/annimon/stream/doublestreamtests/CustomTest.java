...
public final class CustomTest {
    ...
    public void testCustomIntermediateOperator_Zip() {
        ...
        DoubleStream result = s1.chain(new CustomOperators.ZipWithIntStream(s2, op));
    ...
    public void testCustomTerminalOperator_DoubleSummaryStatistics() {
        double[] result = DoubleStream.of(0.1, 0.02, 0.003).chain(new CustomOperators.DoubleSummaryStatistics());
